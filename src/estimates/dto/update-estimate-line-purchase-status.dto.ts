...
export class EstimateLinePurchaseStatusUpdateDto {
  @IsMongoId()
  line_id!: string;
...
export class UpdateEstimateLinePurchaseStatusDto {
  ...
  @Type(() => EstimateLinePurchaseStatusUpdateDto)
  updates!: EstimateLinePurchaseStatusUpdateDto[];
}
