...
import { DocumentLineItemWriteDto } from '../../documents/dto/create-document.dto';
...
/**
 * Editable estimate aggregate for POST /estimates (document-backed).
 * Totals, snapshots, organization, actor, and status are server-derived.
 */
export class CreateEstimateDocumentDto {
  @IsMongoId()
  client_id!: string;
