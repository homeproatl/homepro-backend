...
function normalizePhoneDisplay(value: unknown) {
  ...
  // Keep display formatting; collapse internal whitespace only.
...
export class AddressDto {
  ...
  @IsString()
  @MaxLength(CLIENT_FIELD_LIMITS.address_street)
  street?: string | null;

  @IsOptional()
  @Transform(({ value }) => trimToNull(value))
  @IsString()
  @MaxLength(CLIENT_FIELD_LIMITS.address_suite)
  suite?: string | null;

  @IsOptional()
  @Transform(({ value }) => trimToNull(value))
  @IsString()
  @MaxLength(CLIENT_FIELD_LIMITS.address_city)
  city?: string | null;

  @IsOptional()
  @Transform(({ value }) => trimToNull(value))
  @IsString()
  @MaxLength(CLIENT_FIELD_LIMITS.address_state)
  state?: string | null;

  @IsOptional()
  @Transform(({ value }) => trimToNull(value))
  @IsString()
  @MaxLength(CLIENT_FIELD_LIMITS.address_postal_code)
  postal_code?: string | null;

  @IsOptional()
  @Transform(({ value }) => trimToNull(value))
  @IsString()
  @MaxLength(CLIENT_FIELD_LIMITS.address_country)
  country?: string | null;
}
