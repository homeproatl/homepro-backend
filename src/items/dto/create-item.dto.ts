...
const MATERIALISH_TYPES = new Set<ItemType>(['material', 'equipment']);
...
export function isMaterialishItemType(itemType: ItemType) {
  return MATERIALISH_TYPES.has(itemType);
}
